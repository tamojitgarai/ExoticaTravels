 ...
 * @author TAMOJIT
 */
@WebServlet(name = "Welcomeadminpage", urlPatterns = {"/Welcomeadminpage"})
public class Welcomeadminpage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Welcomeadminpage</title>");            
            out.println("</head>");
            out.println("<body>"
                    ...
                    + "</td>"
                    + "<td bgcolor='#000080' align='center'>"
                    + "<font style='font-family:'Arial Rounded MT Bold',Gadget,sans-serif;' size='+4' collor='#FFE4B5'>Exotica Travels</font>"
                    + "</td>"
